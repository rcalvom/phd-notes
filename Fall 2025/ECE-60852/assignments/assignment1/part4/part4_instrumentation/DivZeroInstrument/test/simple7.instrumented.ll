...
entry:
  ...
  tail call void @__coverage__(i32 4, i32 7), !dbg !10
  ...
  tail call void @__coverage__(i32 4, i32 17), !dbg !15
  call void @llvm.dbg.declare(metadata i32* %z, metadata !16, metadata !DIExpression()), !dbg !15
  tail call void @__coverage__(i32 5, i32 3), !dbg !17
...
if.end:                                           ; preds = %if.else, %if.then
  tail call void @__coverage__(i32 10, i32 7), !dbg !25
  %1 = load i32, i32* %x, align 4, !dbg !25
  tail call void @__coverage__(i32 10, i32 9), !dbg !27
...
if.then2:                                         ; preds = %if.end
  tail call void @__coverage__(i32 11, i32 9), !dbg !29
  %2 = load i32, i32* %y, align 4, !dbg !29
  tail call void @__coverage__(i32 11, i32 13), !dbg !31
  %3 = load i32, i32* %x, align 4, !dbg !31
  tail call void @__coverage__(i32 11, i32 11), !dbg !32
  tail call void @__sanitize__(i32 %3, i32 11, i32 11), !dbg !32
...
if.end3:                                          ; preds = %if.then2, %if.end
  tail call void @__coverage__(i32 13, i32 1), !dbg !35
  ret void, !dbg !35
}
...
entry:
  tail call void @__coverage__(i32 16, i32 3), !dbg !39
  call void @f(), !dbg !39
  tail call void @__coverage__(i32 17, i32 1), !dbg !40
  ret i32 0, !dbg !40
}
...
!1 = !DIFile(filename: "simple7.c", directory: "/workspace/part4/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
