...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %u1, metadata !12, metadata !DIExpression()), !dbg !11
  tail call void @__coverage__(i32 4, i32 12), !dbg !13
  %call = call i32 @getchar(), !dbg !13
  tail call void @__coverage__(i32 4, i32 7), !dbg !11
  store i32 %call, i32* %u1, align 4, !dbg !11
  tail call void @__coverage__(i32 5, i32 7), !dbg !14
  call void @llvm.dbg.declare(metadata i32* %u2, metadata !15, metadata !DIExpression()), !dbg !14
  tail call void @__coverage__(i32 5, i32 7), !dbg !14
  store i32 4, i32* %u2, align 4, !dbg !14
  tail call void @__coverage__(i32 5, i32 15), !dbg !16
  call void @llvm.dbg.declare(metadata i32* %d, metadata !17, metadata !DIExpression()), !dbg !16
  tail call void @__coverage__(i32 6, i32 7), !dbg !18
  %0 = load i32, i32* %u1, align 4, !dbg !18
  tail call void @__coverage__(i32 6, i32 10), !dbg !20
  %cmp = icmp ne i32 %0, 0, !dbg !20
  tail call void @__coverage__(i32 6, i32 7), !dbg !21
  br i1 %cmp, label %if.then, label %if.else, !dbg !21

if.then:                                          ; preds = %entry
  tail call void @__coverage__(i32 7, i32 9), !dbg !22
  %1 = load i32, i32* %u2, align 4, !dbg !22
  tail call void @__coverage__(i32 7, i32 14), !dbg !24
  %2 = load i32, i32* %u1, align 4, !dbg !24
  tail call void @__coverage__(i32 7, i32 12), !dbg !25
  tail call void @__sanitize__(i32 %2, i32 7, i32 12), !dbg !25
  %div = sdiv i32 %1, %2, !dbg !25
  tail call void @__coverage__(i32 7, i32 7), !dbg !26
  store i32 %div, i32* %d, align 4, !dbg !26
  tail call void @__coverage__(i32 8, i32 3), !dbg !27
  br label %if.end, !dbg !27

if.else:                                          ; preds = %entry
  tail call void @__coverage__(i32 9, i32 9), !dbg !28
  call void @llvm.dbg.declare(metadata i32* %d1, metadata !30, metadata !DIExpression()), !dbg !28
  tail call void @__coverage__(i32 9, i32 13), !dbg !31
  %3 = load i32, i32* %u2, align 4, !dbg !31
  tail call void @__coverage__(i32 9, i32 19), !dbg !32
  %4 = load i32, i32* %u1, align 4, !dbg !32
  tail call void @__coverage__(i32 9, i32 22), !dbg !33
  %add = add nsw i32 %4, 1, !dbg !33
  tail call void @__coverage__(i32 9, i32 16), !dbg !34
  tail call void @__sanitize__(i32 %add, i32 9, i32 16), !dbg !34
  %div2 = sdiv i32 %3, %add, !dbg !34
  tail call void @__coverage__(i32 9, i32 9), !dbg !28
  store i32 %div2, i32* %d1, align 4, !dbg !28
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  tail call void @__coverage__(i32 11, i32 3), !dbg !35
  ret i32 0, !dbg !35
}
...
!1 = !DIFile(filename: "simple6.c", directory: "/workspace/part4/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
...
!12 = !DILocalVariable(name: "u1", scope: !7, file: !1, line: 4, type: !10)
...
!30 = !DILocalVariable(name: "d", scope: !29, file: !1, line: 9, type: !10)
