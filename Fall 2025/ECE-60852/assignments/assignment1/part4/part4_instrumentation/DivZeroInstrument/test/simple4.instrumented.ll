...
entry:
  ...
  tail call void @__coverage__(i32 2, i32 10), !dbg !13
  call void @llvm.dbg.declare(metadata i32* %b, metadata !14, metadata !DIExpression()), !dbg !13
  tail call void @__coverage__(i32 3, i32 7), !dbg !15
  call void @llvm.dbg.declare(metadata i32* %c, metadata !16, metadata !DIExpression()), !dbg !15
  tail call void @__coverage__(i32 3, i32 7), !dbg !15
  store i32 0, i32* %c, align 4, !dbg !15
  tail call void @__coverage__(i32 4, i32 7), !dbg !17
  %0 = load i32, i32* %c, align 4, !dbg !17
  tail call void @__coverage__(i32 4, i32 5), !dbg !18
  store i32 %0, i32* %b, align 4, !dbg !18
  tail call void @__coverage__(i32 5, i32 7), !dbg !19
  %1 = load i32, i32* %b, align 4, !dbg !19
  tail call void @__coverage__(i32 5, i32 5), !dbg !20
  store i32 %1, i32* %a, align 4, !dbg !20
  tail call void @__coverage__(i32 6, i32 7), !dbg !21
  call void @llvm.dbg.declare(metadata i32* %d, metadata !22, metadata !DIExpression()), !dbg !21
  tail call void @__coverage__(i32 6, i32 11), !dbg !23
  %2 = load i32, i32* %a, align 4, !dbg !23
  tail call void @__coverage__(i32 6, i32 15), !dbg !24
  %3 = load i32, i32* %c, align 4, !dbg !24
  tail call void @__coverage__(i32 6, i32 13), !dbg !25
  tail call void @__sanitize__(i32 %3, i32 6, i32 13), !dbg !25
  %div = sdiv i32 %2, %3, !dbg !25
  tail call void @__coverage__(i32 6, i32 7), !dbg !21
  store i32 %div, i32* %d, align 4, !dbg !21
  tail call void @__coverage__(i32 7, i32 7), !dbg !26
  %4 = load i32, i32* %c, align 4, !dbg !26
  tail call void @__coverage__(i32 7, i32 9), !dbg !27
  %add = add nsw i32 %4, 1, !dbg !27
  tail call void @__coverage__(i32 7, i32 5), !dbg !28
  store i32 %add, i32* %c, align 4, !dbg !28
  tail call void @__coverage__(i32 8, i32 7), !dbg !29
  %5 = load i32, i32* %c, align 4, !dbg !29
  tail call void @__coverage__(i32 8, i32 9), !dbg !30
  %mul = mul nsw i32 %5, 0, !dbg !30
  tail call void @__coverage__(i32 8, i32 5), !dbg !31
  store i32 %mul, i32* %c, align 4, !dbg !31
  tail call void @__coverage__(i32 9, i32 7), !dbg !32
  call void @llvm.dbg.declare(metadata i32* %e, metadata !33, metadata !DIExpression()), !dbg !32
  tail call void @__coverage__(i32 9, i32 11), !dbg !34
  %6 = load i32, i32* %a, align 4, !dbg !34
  tail call void @__coverage__(i32 9, i32 15), !dbg !35
  %7 = load i32, i32* %c, align 4, !dbg !35
  tail call void @__coverage__(i32 9, i32 13), !dbg !36
  tail call void @__sanitize__(i32 %7, i32 9, i32 13), !dbg !36
  %div1 = sdiv i32 %6, %7, !dbg !36
  tail call void @__coverage__(i32 9, i32 7), !dbg !32
  store i32 %div1, i32* %e, align 4, !dbg !32
  tail call void @__coverage__(i32 10, i32 3), !dbg !37
  ret i32 0, !dbg !37
}
...
!1 = !DIFile(filename: "simple4.c", directory: "/workspace/part4/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
...
!13 = !DILocation(line: 2, column: 10, scope: !7)
!14 = !DILocalVariable(name: "b", scope: !7, file: !1, line: 2, type: !10)
!15 = !DILocation(line: 3, column: 7, scope: !7)
!16 = !DILocalVariable(name: "c", scope: !7, file: !1, line: 3, type: !10)
...
!22 = !DILocalVariable(name: "d", scope: !7, file: !1, line: 6, type: !10)
...
!33 = !DILocalVariable(name: "e", scope: !7, file: !1, line: 9, type: !10)
