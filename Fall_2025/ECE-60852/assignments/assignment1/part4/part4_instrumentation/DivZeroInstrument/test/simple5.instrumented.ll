...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %y, metadata !12, metadata !DIExpression()), !dbg !11
  tail call void @__coverage__(i32 4, i32 7), !dbg !11
  store i32 1, i32* %y, align 4, !dbg !11
  tail call void @__coverage__(i32 4, i32 14), !dbg !13
  call void @llvm.dbg.declare(metadata i32* %z, metadata !14, metadata !DIExpression()), !dbg !13
  tail call void @__coverage__(i32 4, i32 14), !dbg !13
  store i32 1, i32* %z, align 4, !dbg !13
  tail call void @__coverage__(i32 5, i32 7), !dbg !15
  call void @llvm.dbg.declare(metadata i32* %un, metadata !16, metadata !DIExpression()), !dbg !15
  tail call void @__coverage__(i32 6, i32 3), !dbg !17
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %un), !dbg !17
  tail call void @__coverage__(i32 7, i32 7), !dbg !18
  call void @llvm.dbg.declare(metadata i32* %x, metadata !19, metadata !DIExpression()), !dbg !18
  tail call void @__coverage__(i32 7, i32 11), !dbg !20
  %0 = load i32, i32* %un, align 4, !dbg !20
  tail call void @__coverage__(i32 7, i32 14), !dbg !21
  %add = add nsw i32 %0, 1, !dbg !21
  tail call void @__coverage__(i32 7, i32 7), !dbg !18
  store i32 %add, i32* %x, align 4, !dbg !18
  tail call void @__coverage__(i32 8, i32 7), !dbg !22
  %1 = load i32, i32* %y, align 4, !dbg !22
  tail call void @__coverage__(i32 8, i32 11), !dbg !23
  %2 = load i32, i32* %x, align 4, !dbg !23
  tail call void @__coverage__(i32 8, i32 9), !dbg !24
  tail call void @__sanitize__(i32 %2, i32 8, i32 9), !dbg !24
  %div = sdiv i32 %1, %2, !dbg !24
  tail call void @__coverage__(i32 8, i32 5), !dbg !25
  store i32 %div, i32* %z, align 4, !dbg !25
  tail call void @__coverage__(i32 9, i32 3), !dbg !26
  ret i32 0, !dbg !26
}
...
!1 = !DIFile(filename: "simple5.c", directory: "/workspace/part4/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
...
!12 = !DILocalVariable(name: "y", scope: !7, file: !1, line: 4, type: !10)
!13 = !DILocation(line: 4, column: 14, scope: !7)
!14 = !DILocalVariable(name: "z", scope: !7, file: !1, line: 4, type: !10)
!15 = !DILocation(line: 5, column: 7, scope: !7)
!16 = !DILocalVariable(name: "un", scope: !7, file: !1, line: 5, type: !10)
