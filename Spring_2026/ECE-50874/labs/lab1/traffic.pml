...
/*
    ----------------------------------------------------------------
    INSERT LTL HERE
	- Make one declaration per lab element
	- Do one at a time -- keep others commented out
	- Read the messages from SPIN -- errors/warnings are at the 
	  top of its output
    ----------------------------------------------------------------

    Example (uncomment and edit as needed):

    ltl P1 { [] !(ns_green && ew_green) }

    ltl PASS_ns_green_implies_ew_red {
      [] (ns_green -> ew_red)
    }
*/
